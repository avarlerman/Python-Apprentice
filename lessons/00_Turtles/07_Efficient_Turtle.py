...
def draw_polygon(sides):
    ...
    for i in range(sides):                 # Loop through the number of sides
        tina.forward(25)                              # Move tina forward by the forward distance
        tina.left(angle)                              # Turn tina left by the left turn

tina.color('hot pink')
draw_polygon(4)                        # Draw a square
tina.penup()
tina.goto(0,50)                                      # Move tina to another spot on the screen
tina.pendown()
draw_polygon(5)                        # Draw a pentagon
tina.penup()
tina.goto(0,100)                                      # Move tina to another spot on the screen
tina.pendown()
